...
void tests() {
	...
	double** source_mat5 = create(r5, c5);
	...
	double** result_mat1 = create(r1, c1);
	result_mat1[0][0] = 4;	result_mat1[0][1] = 5;
	fill_mas(result_mat1, r1, c1);


	double** result_mat2 = create(r2, c2);
	result_mat2[0][0] = 2;	result_mat2[0][1] = 9;
	fill_mas(result_mat2, r2, c2);


	double** result_mat3 = create(r3, c3);
	result_mat3[0][0] = -5;	result_mat3[0][1] = 2;	result_mat3[0][2] = -3.9;
	fill_mas(result_mat3, r3, c3);


	double** result_mat4 = create(r4, c4);
	result_mat4[0][0] = 5;	result_mat4[0][1] = 4;	result_mat4[0][2] = 3;
	fill_mas(result_mat4, r4, c4);


	double** result_mat5 = create(r5, c5);
	result_mat5[0][0] = 40;	result_mat5[0][1] = -20;
	fill_mas(result_mat5, r5, c5);
	int i = 0, j = 0;
